...
7. **One idea per paragraph** — open with the main point, support it, close it. Max 3–4 sentences.
...
2. Development     — 2–4 sentences of evidence, examples, or data
...
2. Context — 1–2 sentences orienting the reader
...
2. Summary — 2–3 sentences restating the strongest points
