---
name: client-intake
description: Use at the start of every new business planning engagement, before any section skill is invoked. Presents 10 standard questions to the client, generates a draft project brief with [TO CONFIRM] markers, then produces 5–7 targeted follow-up questions to close remaining gaps. Invoke whenever a new business plan, investor pitch, grant application, bank loan proposal, or feasibility study is commissioned.
---
...
What problem or gap in the market does your business address? Who is experiencing this problem and why are they not being served well today? What made you identify this opportunity — personal experience, research, a gap you observed — and why is now the right time to act on it?
...
Analyse the draft brief and generate **5–7 follow-up questions**. These are not standard questions — write them specifically for this client's answers. Do not use generic or templated language.
...
- The set of 5–7 questions, if answered, would resolve all remaining [TO CONFIRM] markers in Sections 4, 7, 8, and 9 as a minimum
