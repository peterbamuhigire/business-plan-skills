...
- **3C Strategic Triangle and competitive dynamics (Ohmae)**: See `references/mind-of-strategist-ohmae.md` for Ohmae's 3C Strategic Triangle (corporation/customer/competition), Key Factors for Success identification method (hypothesis-first + KFS industry table), four routes to strategic advantage (KFS focus, relative superiority, aggressive initiatives, Strategic Degrees of Freedom), Strategic Planning Unit tests, customer segmentation (objectives vs. coverage), profit diagrams, issue diagrams, challenging constraints method, and Uganda/EA application  from Ohmae (McGraw-Hill, 1982). **Read when defining the competitive positioning logic, especially for businesses that cannot compete on all dimensions and need to identify where to concentrate.**
