...
- `references/presentation-secrets-jobs-gallo.md` - read for narrative structure and memorable moments: a three-part storyline, one core message, grouping points in threes, a headline short enough to repeat, making numbers meaningful, strong openings, rehearsal method and a table applying these to a business-plan deck.
- `references/persuasive-presentations-duarte.md` - read for slide design standards and persuasive narrative: contrasting the present with the possible, headline-plus-evidence slides, mapping audience resistance, reducing visual clutter, data and financial chart standards, and before-and-after slide transformations. Primary visual design reference (Duarte's "sparkline" idea is named where used).
...
- `references/innovative-presentations-anthony.md` - read for engagement and adaptation: audience-engagement techniques, alternative openings, non-linear presentation options, storyboarding, and adapting to sceptical, analytical or executive audiences.
- `references/presentation-skills-edwards.md` - read for delivery coaching: voice, managing nerves, body language, answering questions, self-assessment, before/during/after checklists and a development progression; the client training protocol draws on it.
- [`references/pitch-and-presentation-delivery-standard.md`](references/pitch-and-presentation-delivery-standard.md) - read when preparing any live pitch, lender or board presentation, tender oral or workshop: medium choice, goals, nine audience questions, message structure, data slides, room and power readiness, rehearsal, hard questions, debrief, meeting discipline and an evaluation rubric.
