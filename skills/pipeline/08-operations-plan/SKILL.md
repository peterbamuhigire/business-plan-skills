...
- **Digital operating-model redesign**: See `../../meta-strategy/meta-digital-transformation/references/digital-business-model-redesign-tests.md` (five-domain and demand-driven tests) and `../../meta-strategy/meta-digital-transformation/SKILL.md` when deciding whether the real operational move is workflow digitisation, data capture, platform participation, or subscription/service redesign rather than more headcount or paper process.
- **DevOps operating model for software and SaaS businesses**: See `references/digital-delivery-operating-model.md` for CI/CD, release management, observability, incident response, IaC, DevSecOps, PHP/LAMP operations, cloud-native maturity, and business-plan translation of DevOps capabilities. **Read when the business sells software, runs a platform, hosts customer workloads, depends on digital service uptime, or needs a credible technology operations plan.**
- **SaaS tenancy model and MSP trap test**: See `references/saas-tenancy-model-and-msp-trap-test.md` for the six SaaS business pillars, installed/MSP/SaaS classification, pool-silo-bridge tenancy mapped to pricing tiers, control-plane investment, onboarding, noisy-neighbour controls, and per-tenant cost telemetry. **Read when a plan claims platform, multi-tenant, or SaaS economics.**
...
- **SME operating discipline**: See `references/sme-operating-discipline-checklist.md` for records, customer experience, growth-with-systems, partnership terms, marketing basics, leakage controls, and proportionate digital adoption. **Read when the plan is for a founder-led SME, shop, clinic, school, workshop, or cash-handling business.**
...
- **Industrial production, inventory, warehousing, MRP, scheduling, facilities, and green manufacturing**: See `references/production-capacity-mrp-and-warehouse-planning.md` for material-requirements planning, master scheduling, safety stock, lot sizing, pegging, factory capacity, setup/changeover, warehouse slotting, material handling, quality traceability, and resource-efficiency metrics. **Read when the business manufactures, processes, warehouses, distributes, exports physical goods, or carries material inventory risk.**
- **Logistics network design, inventory service levels, transportation, carrier/fleet strategy, and trade documentation**: See `references/logistics-network-inventory-and-transport-planning.md` for CLTD-derived planning rules covering network design, inventory policy, transportation execution, 3PL/4PL/LLP models, Incoterms/customs controls, reverse logistics, and logistics KPIs. **Read when the business imports, exports, warehouses, distributes, delivers, aggregates agricultural output, operates a fleet, uses carriers, or carries meaningful stockout/backorder risk.**
...
- [Phrase bank, entry 08](../../language/writing-quality/references/business-plan-phrase-bank-sections-01-08.md) — read while drafting: purpose, keywords, slot-templates, tone rules, before-and-after rewrites and red-flag phrases for this section; apply the strategy-type emphasis from the [phrase-bank index](../../language/writing-quality/references/business-plan-phrase-bank.md).
