...
- `references/manager-financial-intelligence-brief.md` - B07-A03 manager-facing profit, cash, ratio, alternative, and source-trace brief.
- `../../../docs/kaizen/fpa-assumption-trace.md` - B03-A04 assumption-to-narrative trace and bounded FP&A pilot contract.
- `../../../references/healthcare-payer-assumptions-and-reconciliation.md` - B08-A02 synthetic payer, volume, timing, AR, and cash reconciliation contract.
...
- **Data analytics for planning and management dashboards**: See `../../meta-strategy/meta-statistics/references/analytics-ladder-and-kpi-standard.md` when projections depend on historical sales, operational datasets, forecasts, AI analytics, scenario analysis, KPI dashboards, or variance logic. Use the descriptive/diagnostic/predictive/prescriptive ladder to keep forecasts, targets, and recommendations properly separated.
- **Industrial production and inventory model link**: See `../08-operations-plan/references/production-capacity-mrp-and-warehouse-planning.md` when modelling manufacturing, food processing, warehousing, logistics, wholesale, or any business with material stock risk. Use it to structure raw-material consumption, MRP-style purchasing, safety stock, WIP, yield/scrap, capacity, warehousing, and resource-efficiency assumptions.
- **Accounting, bookkeeping, ERP finance controls, cost accounting, and finance workbook discipline**: See `references/finance-operating-system-and-controls-checklist.md` when the plan involves ERP/POS, school fees, patient billing, inventory, payroll, tax, mobile money, credit sales, supplier credit, cost centres, management accounts, Excel models, or weak/informal records. Use it to strengthen accounting basis, reconciliations, source documents, control accounts, close cadence, cost accounting, variance analysis, and model checks.
...
- [Phrase bank, entry 10](../../language/writing-quality/references/business-plan-phrase-bank-sections-09-16.md) — read while drafting: purpose, keywords, slot-templates, tone rules, before-and-after rewrites and red-flag phrases for this section; apply the strategy-type emphasis from the [phrase-bank index](../../language/writing-quality/references/business-plan-phrase-bank.md).
