...
1. Define the exact saas agent revenue recognition decision, intended reader, jurisdiction, business stage, and permission boundary.
...
5. Produce revenue-recognition policy schedule and contract-liability bridge with the evidence, exception, and handoff records; reconcile every shared assumption with its owning section.
