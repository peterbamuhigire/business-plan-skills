# Full lifecycle proposal workflow

Parent: [Proposal Architect](../SKILL.md)

This extracted reference preserves the detailed workspace, opportunity-analysis, drafting, review, and compilation workflow. The parent skill controls routing, permissions, stop conditions, degraded mode, outputs, and release acceptance.
