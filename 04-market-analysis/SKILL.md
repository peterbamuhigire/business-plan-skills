...
- **Strategic analysis toolkit (PESTLE, Porter's Five Forces, SWOT, MOST, CSFs/KPIs)**: See `../meta-market-validation/references/business-analysis-techniques-cadle.md` for the full descriptions of all 12 strategy tools (Tools 1–12), their correct use in external environment and internal capability analysis, and Uganda/EA adaptation notes for low-data markets — Source: Cadle, Paul & Turner (BCS, 2010). **Read when building or reviewing the industry overview, external environment scan, or internal capability sections of market analysis.**
