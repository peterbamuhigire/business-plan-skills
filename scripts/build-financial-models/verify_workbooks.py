...
WORKBOOKS = [
    ...
    ("skills/saas-unit-economics-and-cohort-model/templates/saas-cohort-and-retention-model.xlsx", 7,
        ["README","Inputs","Logo-Cohort","Revenue-Cohort","NRR-GRR","Involuntary-Churn","Dashboard","Africa-Notes"]),
    ("skills/10-financial-projections/templates/saas-financial-projection-3yr-5yr.xlsx", 9,
        ["README","Inputs","ARR-Waterfall","MRR-Detail","Headcount","PnL","Cash","Sensitivity","Scenarios","Bankability-Dashboard","Africa-Notes"]),
    ("skills/14-ai-integration/templates/saas-ai-cost-of-tenant-calculator.xlsx", 7,
