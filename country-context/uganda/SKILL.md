...
| Capital | Kampala |
| Primary languages | English (official), Luganda, Swahili |
| Currency | Uganda Shilling |
| Currency code | **UGX** |
| Exchange rate (current) | UGX 3,550 per USD (Q1 2025/26, UBOS KEI) |
| **Conservative planning rate** | **UGX 3,700 per USD** (10% buffer for depreciation risk) |
| Rate source | Bank of Uganda / UBOS Key Economic Indicators |
...
| Element | Detail |
|---------|--------|
| Working-age population | 23.5 million |
| Formal wage employment | ~10 million (paid workers; including informal sector) |
...
| EAC nationals | No work permit required (EAC Common Market Protocol, Art.10) |
...
| Indicator | Value |
|-----------|-------|
| Population | 45.9 million (NPHC 2024) |
| Population growth | ~3.2%/year (one of highest in world) |
| Urban population | ~26% (urbanisation accelerating) |
| Kampala | 1.797 million |
| Internet penetration | ~50% (UCC 2024) |
| Mobile money penetration | ~80% of adults |
| Key exports | Coffee (largest), gold, fish, tea, flowers, maize |
| Key imports | Petroleum, machinery, vehicles, wheat, pharmaceuticals |
| Top trading partners (exports) | UAE, Kenya, South Sudan, China, EU |
| EAC market access | Free trade within EAC; 500M+ consumers in trade bloc |
...
|---------------|--------|
| Corruption | Transparency International CPI ~2.6/10 (ranked ~142/180) |
| Political stability | Generally stable; election cycles (2026) affect public spending |
| EFRIS compliance | UGX 8M/month penalty; enforcement increasing 2025 |
| NIN/BRN gate | New 2025 rule; delays company formation if ID issues exist |
...
- UBOS Kenya Economic Indicators (UBOS KEI), Q1 2025/26
- EAC Secretariat trade data 2024
- MAAIF / URA policy documents
...
Data gaps: No national minimum wage (sector-specific only); PAYE bands subject to annual Finance Act changes
Conservative rule: Always use UGX 3,700/$1 for projections (not current spot rate)
```
